...
You can pass the encryption passphrase along with a block of code to be executed once the wallet is unlocked. After the code is executed the wallet is re-locked.

  wallet.unlock("passphrase") do         # Defaults to 20 seconds if not specified
